...
// // 初期値の設定
// let currentValue = "0"; //入力中の数字
// let previousValue = null; //演算をを押したらcurrentValueをこちらに移す
// let operator = null; //演算子の初期値
// let justCBtn = false; // C直後 
...
//   if (previousValue !== null && currentValue !== "0") {
//     // 入力中に文字列としての数字と演算子を押す前の文字列の数字をnumberに変換
...
//   $display.value = previousValue; //計算途中の結果を出す
// }
...
function handleOperator(op: string): void {
  ...
  if (previousValue === null && currentValue === "0" && op !== "-") return;
